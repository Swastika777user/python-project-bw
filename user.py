...
# git config --global user.name "Swastika Rijal"
# git config --global user.email "rijalswastika78@gmail.com"
...
def main():
    ...
    if user_input == "1":
        ...
        user_data = [] # [ram, bahadur, gogle,..] "gogle": Unknown word.
        ...
        confirm = input("Are you sure you want to delte all users? (y/n): ")
        if confirm == "y":
            delete_users(conn)
    elif user_input =="8":
        user_id = input("Enter the id of user: ")
